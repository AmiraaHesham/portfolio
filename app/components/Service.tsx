            ...
            <div className=' flex flex-col  w-[80%] '>
                ...
                <div className='flex flex-col xs:justify-center xs:items-center lg:justify-normal lg:items-stretch'>
                    ...
                    <div data-aos="fade-up" className='xl:w-[650px] xs:w-[100%] rounded-md p-5 border border-color4 mt-10 shadow-md shadow-color4'>
                        ...
                        <h1 className='text-xl mt-2 text-left'>I create websites based on your ready-made design. Whether it’s a landing page or a business card website, I will make it look great and work smoothly on any device.</h1>
                    </div>
                    ...
                    <div className='flex lg:justify-end xs:justify-center'>
                        <div data-aos="fade-up" className='xl:w-[650px] xs:w-[100%] rounded-md p-5 border border-color4 shadow-md shadow-color4 '>
                            ...
                            <h1 className='text-xl mt-2 text-left'>I Can Design Your Website From Scraatch. I Create Modern, Simple And Easy
                    ...
                    <div data-aos="fade-up" className='xl:w-[650px] xs:w-[100%] rounded-md p-5 border border-color4 shadow-md shadow-color4'>
                        ...
                        <h1 className='text-xl mt-2 text-left'>I Create Resbonsive Website Based On Your Ready-Made Design
