            ...
            <div className=' mb-10  w-[90%]' >
                ...
                <div className='mt-16'>
                    ...
                    <div className="flex justify-center items-center">
                        <div className=' grid xl:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 my-10 gap-5 '>
                            <img data-aos="fade-up" src="/smart attendance/signIn page.jpg" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                            ...
                            <img data-aos="fade-up" src="/smart attendance/overOll page.jpg" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                ...
                <div className='mt-20'>
                    ...
                    <div className=' grid xl:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 my-10 gap-5 '>
                        ...
                        <img src="/WatchHub/home page2.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                    ...
                    <div className=' grid xl:grid-cols-6 md:grid-cols-2 xs:grid-cols-2 my-10 gap-5 '>
                        <img src="/WatchHub/page1 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[200px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                        <img src="/WatchHub/page2 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[200px] h-[300px]  rounded-lg shadow-md shadow-color4 ' />
                        <img src="/WatchHub/page3 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[200px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                        <img src="/WatchHub/page4 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[200px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                        <img src="/WatchHub/page5 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[200px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                        <img src="/WatchHub/page6 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[200px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                ...
                {/* <div className='mt-20'>
                    ...
                    <div className=' grid xl:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 my-10 gap-5 '>
                        ...
                        <img src="/WatchHub/home page2.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                        <img src="/WatchHub/details page1.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                        <img src="/WatchHub/page1 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
                        <img src="/WatchHub/page2 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg shadow-md shadow-color4 ' />
                        <img src="/WatchHub/page3 phone.jpg" data-aos="fade-up" alt="Smart Attendance System" className='w-[450px] h-[300px]  rounded-lg  shadow-md shadow-color4' />
